...
const sel = 'w-full min-w-0 rounded-[var(--r-control)] border border-[color:var(--ink-200)] bg-white px-3 py-2 text-base md:text-sm text-[color:var(--ink-700)] outline-none focus:border-[color:var(--brand-navy-900)]';
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        {drops.length > 0 && (
          <button onClick={() => setOpen((o) => !o)} aria-expanded={open}
            className="ui-press flex shrink-0 items-center justify-center gap-2 rounded-[var(--r-control)] border border-[color:var(--ink-200)] bg-white px-4 py-2.5 text-sm font-semibold text-[color:var(--ink-700)]">
