...
export default function NextTestCard({ next, careerName }) {
  ...
  return (
    <section className="rounded-[16px] border p-5" style={{ borderColor: 'var(--brand-gold-500)', background: 'var(--warning-50)' }}>
      ...
      <p className="tp-eyebrow mt-3" style={{ color: 'var(--brand-navy-700)' }}>Why we are testing this</p>
      <p className="tp-body mt-1" style={{ color: 'var(--ink-700)' }}>{next.why}</p>

      <Link
        to={next.to}
        className="ui-press tp-body mt-4 inline-flex items-center gap-2 rounded-[12px] px-5 py-3 font-semibold text-white"
