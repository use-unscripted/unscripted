...
const PathButton = forwardRef(function PathButton({ path, active, rotateChevron = false, ...rest }, ref) {
  ...
  return (
    <button
      ref={ref}
      type="button"
      className="group relative flex w-full items-center gap-3 rounded-[var(--r-control)] px-4 py-3.5 text-left transition-colors duration-200 hover:-translate-y-px"
      style={{
