...
export default function AddMissionModal({ experiment, onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(5,8,22,0.5)' }}>
      <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-[var(--r-surface)] bg-white p-6 sm:p-8">
        ...
        <div className="mb-5 rounded-[var(--r-control)] p-3 border border-[color:var(--ink-200)] bg-[color:var(--ink-50)]">
