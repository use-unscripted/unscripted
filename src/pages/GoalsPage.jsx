            ...
            return (
              <div key={g.id} className="rounded-[var(--r-surface)] border border-[color:var(--ink-200)] bg-white p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <select className="rounded-lg border border-[color:var(--ink-200)] bg-[color:var(--page-surface)] px-2.5 py-2 text-base md:text-sm text-[color:var(--ink-700)] outline-none"
