  ...
  return (
    <main className="min-h-screen px-5 py-10" style={{ background: '#FAFAF9' }}>
      <div className="mx-auto max-w-4xl">
        ...
        <section className="grid gap-5 rounded-[24px] border border-[#E2E8F0] bg-white p-7 shadow-sm sm:grid-cols-2 sm:p-10">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="mt-2 text-xs text-[#64748B]">Be honest. A focused 6 hours beats an imaginary 20.</p>
          </div>
          <button
            onClick={submit}
            disabled={saving}
