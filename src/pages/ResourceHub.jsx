...
const DEFAULT_RESOURCES = [
  ...
  { name: 'Apollo.io (free tier)', category: 'networking_tools', description: 'Professional contact and outreach platform for finding verified work emails and managing networking outreach.', target_user: 'Students building intentional outreach lists', price_type: 'freemium', external_url: 'https://apollo.io', pros: ['Large verified database', 'Free tier available'], limitations: ['Terms of use apply, so use it for permitted outreach only'], recommendation_reason: 'Useful for finding contacts at companies you want to explore.', last_reviewed: '2025-01-01' },
  { name: 'Calm / Headspace', category: 'wellness', description: 'Meditation and mindfulness apps for stress management and sleep.', target_user: 'Students managing high workloads', price_type: 'freemium', external_url: 'https://calm.com', pros: ['Accessible', 'Evidence-based techniques'], limitations: ['Not a replacement for professional mental health support'], recommendation_reason: 'Unscripted recommends protecting mental clarity, because performance depends on recovery.', last_reviewed: '2025-01-01' },
];
