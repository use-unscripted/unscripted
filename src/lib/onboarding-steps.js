...
export const STEPS = [
  {
    ...
    hint: 'There is no right answer, and a low number is not a problem. This is the number we measure your progress against.',
  },
  {
    key: 'current_careers_considered',
    kind: 'tags',
    question: 'Any careers you are already considering?',
    hint: 'Add as many or as few as you like. Leave it empty if nothing comes to mind, and nothing about the product changes.',
  ...
  },
  {
    ...
    hint: 'Knowing what you do not want is real information, so we will not suggest it back to you.',
  ...
  },
  {
    ...
    hint: 'Naming the pressure keeps it separate from what you actually want. Both answers change what we suggest.',
  },
  {
  ...
  },
  {
    ...
    hint: 'Tap whatever sounds like you. This is a starting guess, not a personality label, and your experiments are what test it.',
  ...
  },
  {
    ...
    hint: 'If you have never actually done one, say so. We treat "never experienced this" very differently from "dislike".',
  },
  {
    key: 'values',
    kind: 'values',
    question: 'What matters to you in the work itself?',
    hint: 'You do not have to optimise for one thing. Several can be essential.',
  },
  {
    key: 'willingness',
    kind: 'toggles',
  ...
  },
  {
    ...
    hint: 'Tap what applies. Adding a line about what you enjoyed or disliked is optional and useful.',
  },
  {
    key: 'major_uncertainties',
    kind: 'chips',
    question: 'What are you still trying to figure out?',
    hint: 'These become the questions your experiments are built to answer, so pick the ones that are genuinely open.',
  ...
  },
  {
    ...
    hint: 'Your guides and outreach messages go out in your name, so we need these three.',
  },
];
